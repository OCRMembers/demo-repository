...
def download_ascii_file():
    ...
    try:
        ...
        # os.getcw permet de récupérer le chemin du répertoire courant
        # os.path.join permet de construire le chemin en ajoutant le séparateur '\' lors de la concaténation
        
        # décommenter les 2 lignes en dessous pour faire le test
        file_path = os.path.join(os.getcwd(),os.path.join('results','ascii_grid_output_map.asc'))
        ...
        # file_path = "results/ascii_grid_output_map.asc"
